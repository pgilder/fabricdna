...
Template.appBody.helpers({
  videomenuOpen: function() {
    return Session.get(MENU_KEY2) && 'menu-open2';
  },
...
Template.appBody.events({
  'click .js-menu2': function(event) {
    event.stopImmediatePropagation();
    event.preventDefault();
    Session.set(MENU_KEY2, ! Session.get(MENU_KEY2));
  },

  'click .js-back2': function(event) {
    nextInitiator = 'back';
  ...
  'click .content-overlay': function(event) {
    Session.set(MENU_KEY2, false);
    event.preventDefault();
  },

  'click #menu2 a': function(event) {
    nextInitiator = 'menu2'
    Session.set(MENU_KEY2, false);
  },
